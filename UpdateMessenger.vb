...
Module UpdateMessenger
    Sub ShowMessage()
        Try
            ...
            UpdMsg = $"Добавлен английский интерфейс{vbCrLf}Добавлены следующие изменения в отображении файлов и таблиц концентраций:{vbCrLf}{vbTab}1. Изменен формат файлов концентраций, однако, программа совместима со старым форматом .con{vbCrLf}{vbTab}2. Появилась возможность просматривать значения активностей элементов, паспортные значения которых не найдены в эталоне.{vbCrLf}{vbTab}3. Отмеченная опция 'Рассчитать для фильтров' выводит значения концентраций в микрограммах.{vbCrLf}{vbTab}4. Повышена стабильность приложения."
            'update message
